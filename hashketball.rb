...
#returns # of points scored by that player
...
#returns array of players and their jersey number
...
#method finds player w biggest shoe size and returns # of rebounds
